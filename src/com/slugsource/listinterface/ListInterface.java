package com.slugsource.listinterface;
...
public interface ListInterface<T>
{
    ...
    *        in the order in which they occur in the list. */
    ...
    /** Task: Swaps the position of two elements in the list.
     * @param positionOne  The position of the first element to swap
     * @param positionTwo  The position of the second element to swap */
    public void swap(int positionOne, int positionTwo);
    
    
    /** Task: Tests whether two lists are equal.
     * @param otherList  The other list to compare the current list instance to
